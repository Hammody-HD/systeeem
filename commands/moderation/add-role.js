    ...
    try {
      ...
      if (!args[0]) return message.reply({
        embeds: [new MessageEmbed()
          ...
          .setDescription(`${client.allEmojis.m} You must mention a member to give the role.`)
        ]
      });
      if (!mentionedMember) return message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter(ee.footertext, ee.footericon)
          .setDescription(`${client.allEmojis.x} The member mentioned is not in the server.`)
        ]
      });/*
      ...
      if (!args[1]) return message.reply({
        embeds: [new MessageEmbed()
          .setColor(ee.mediancolor)
          .setFooter(ee.footertext, ee.footericon)
          .setDescription(`${client.allEmojis.m} You must mention a role to give to the member mentioned.`)
        ]
      });
      ...
      if (message.member.roles.highest.position <= role.position) return message.reply({
        embeds: [new MessageEmbed()
          .setColor(ee.wrongcolor)
          .setFooter(ee.footertext, ee.footericon)
          .setDescription(`${client.allEmojis.x} You cannot give this role as it is the same or above your current highest role.`)
        ]
      });
      ...
      await message.reply({
        embeds: [new MessageEmbed()
          .setColor(ee.color)
          .setFooter(ee.footertext, ee.footericon)
          .setDescription(`${client.allEmojis.y} Successfully Added ${role} to ${mentionedMember}.`)
        ]
      })
    } catch (e) {
